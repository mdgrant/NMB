...
<font size = 4> Figure `r figure_n`. Incidence of residual neuromuscular block (TOFR \<0.9) in RCTs among patients given sugammadex according to whether TOFR was reported as confirmed prior to extubation.  </font>
...
<font size = 4> Figure `r figure_n`. Incidence of residual neuromuscular block (TOFR \<0.9) in RCTs among patients given neostigmine according to whether TOFR was reported as confirmed prior to extubation.  </font>
