...
<font size = 4> Table `r table_n`. Study arms included in analyses of TOFR ≥0.9 prior to extubation (sugammadex used for reversal). All studies utilized quantitative monitoring.</font>
...
<font size = 4> Table `r table_n`. Study arms included in analyses of TOFR ≥0.9 prior to extubation (neostigmine  used for reversal). All studies utilized quantitative monitoring.</font>
