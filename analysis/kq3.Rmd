...
nmm_kable %>%
  ...
  footnote(
    general = "RNMB: residual neuromuscular blockade; OR: odds ratio; CI: confidence interval; RCT: randomized controlled trial; TOFR: train of four ratio; DBS: double burst stimulation; PNS: peripheral nerve stimulator; AMG: acceleromyography; EMG: electromyography; OR: operating room.",
    alphabet = c(
