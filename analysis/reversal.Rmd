...
composite %>% 
  ...
  pack_topnoind(., "Retrospective Cohort", 35, 40) %>%
  # result_pack(., "")
  footnote(
    general = "NS: not specified; mod: moderate; endsurg: end of surgery; shall: shallow; min: minimal; oth: other ",
    # number = c(""),
...
<font size = 4> Figure `r figure_n`. Pooled incidence of postoperative pneumonia in randomized and nonrandomized studies. </font>
...
figure_n <- tab_inc()
```
Results from 3 nonrandomized studies adjusted for potential confounding (Li 2021 and Yu 2021 propensity scores, Kheterpal 2020 matched cohort design).
