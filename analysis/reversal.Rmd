...
<font size = 4> Table `r table_n`. Incidence of residual neuromuscular blockade and depth of anesthesia according to reversal in adults.</font>
...
<font size = 4> Figure `r figure_n`. Pooled residual neuromuscular blockade (TOFR <0.9) from randomized trials comparing sugammadex and neostigmine according to volatile anesthetic. </font>
...
<font size = 4> Table `r table_n`. Incidence of residual neuromuscular blockade and depth of anesthesia according to reversal in pediatric patients.</font>
