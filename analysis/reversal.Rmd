...
figure_n <- fig_inc()
```
Putz 2016 included a mix of shallow and minimal depth of block.
...
<font size = 4> Table `r table_n`. Rates of recurarization in studies including comparison of sugammadex and neostigmine. </font>
...
<font size = 4> Figure `r figure_n`. Pooled risk difference for recurarization randomized in RCTs comparing sugammadex with neostigmine. </font>
