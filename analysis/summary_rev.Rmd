...
study_char_table_rev <- study_char_rev.dat %>%
  ...
  select(refid, study, eu, un, country, asia, eu, us, ca, sa, noneu, afr, low_r, non_vh_hdi, pilot, ambulatory, one_center, multi_center, general, regional, sedation, starts_with("fund_"), registered, n_enrolled, arms, auth_coi) 
...
table_rev <- study_char_table_rev %>% 
  ...
  summarize(
    ...
    "  Not Reported" = n_per_tf(fund_nr),     "Author COI" = n_per_tf(auth_coi),
...
table_rev %>%
  kbl(
    ...
    col.names = c("Characteristic", "N (%) or Value")
  ) %>%
...
# write_csv(table_rev, "/Users/mgrant/Desktop/study_char_table_rev_rct_adult.csv", na = "")
table_n <- tab_inc()
```
...
# write_csv(pt_char_table_rev, "/Users/mgrant/Desktop/pt_char_table_rev_rct_adult.csv", na = "")
...
# write_csv(table_rev, "/Users/mgrant/Desktop/study_char_table_rev_nrsi_adult.csv", na = "")
table_n <- tab_inc()
```
...
# write_csv(pt_char_table_rev, "/Users/mgrant/Desktop/pt_char_table_rev_nrsi.csv", na = "")
table_n <- tab_inc()
```
...
# write_csv(table_rev, "/Users/mgrant/Desktop/study_char_table_rev_rct_peds.csv", na = "")
table_n <- tab_inc()
```
...
pt_char_table_rev %>% 
  ...
  # row_spec(., 46, italic = TRUE) %>% 
  footnote(
    general = "Car: cardiac; GI: gastrointestinal; Ortho: orthopedic; ENT: otolaryngology (ear, nose, and throat); Urol: urologic; Neuro: neurological; Oralmax: oral maxillofacial.",
    # alphabet = c(" "),
    general_title = "",
    footnote_as_chunk = FALSE
  )

# write_csv(pt_char_table_rev, "/Users/mgrant/Desktop/pt_char_table_rev_rct_peds.csv", na = "")
table_n <- tab_inc()
```

<br/><br/>

## Nonrandomized (pediatric)
...
# write_csv(table_rev, "/Users/mgrant/Desktop/study_char_table_rev_nrsi_peds.csv", na = "")
table_n <- tab_inc()
```
...
pt_char_table_rev %>% 
  ...
  column_spec(2, width = "8em") %>% 
  footnote(
    general = "Car: cardiac; Gen: general",
    # alphabet = c(" "),
    general_title = "",
    footnote_as_chunk = FALSE
  )

# write_csv(pt_char_table_rev, "/Users/mgrant/Desktop/pt_char_table_rev_nrsi_peds.csv", na = "")
table_n <- tab_inc()
```
